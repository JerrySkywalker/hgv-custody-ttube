function artifact = propagateHgvTrajectoryLegacyStage02(cfg)
%PROPAGATEHGVTRAJECTORYLEGACYSTAGE02 Legacy comparison adapter.
...
artifact.producer = 'ttube.legacy.propagateHgvTrajectoryLegacyStage02';
