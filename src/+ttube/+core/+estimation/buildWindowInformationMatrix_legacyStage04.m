function result = buildWindowInformationMatrix_legacyStage04(accessArtifact, constellation, windowArtifact, cfg)
%BUILDWINDOWINFORMATIONMATRIX_LEGACYSTAGE04 Adapt legacy Stage04 FIM helper.
...
result.producer = 'ttube.core.estimation.buildWindowInformationMatrix_legacyStage04';
