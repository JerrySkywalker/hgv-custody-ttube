function artifact = computeAccessGeometry_legacyStage03(trajectory, constellation, cfg)
%COMPUTEACCESSGEOMETRY_LEGACYSTAGE03 Adapt legacy Stage03 visibility helper.
...
artifact.producer = 'ttube.core.sensor.computeAccessGeometry_legacyStage03';
...
satbank.r_eci_km = permute(constellation.r_eci_km, [1 3 2]); % Nt x 3 x Ns
